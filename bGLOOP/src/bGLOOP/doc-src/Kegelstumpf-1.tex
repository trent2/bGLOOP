...
\begin{tikzpicture}[x={(1cm,0)},y={(0,1)},z={(-0.5cm,-0.5cm)},>={Stealth[scale=.4]}]
  ...
  \path (0,0,-1) ++(120:.25) node[coordinate] (L) {};
  \path (0,0,-1) ++(-30:.25) node[coordinate] (R) {};
  \draw[dashed] (0,0,-1) ++(120:.25) arc(120:330:.25);
  \fill[black!50,opacity=.5] (0,0,-1) circle (.25);
  \fill[black!50,opacity=.7] (0,0,1) circle (.7);
  \fill[inner color=black!50,opacity=.7] (0,0,1) ++(120:.7) arc(120:-30:.7) -- (R) arc(-30:120:.25) -- cycle;
  \draw plot[mark=+] (0,0,1) (0,0,1) circle (.7) (0,0,1) (0,0,-1) ++(-30:.25) arc(-30:120:.25)
